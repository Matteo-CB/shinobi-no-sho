...
# Mapping des noms courts/usuels vers l'id canonique principal. Utilise par
# l'interpreteur d'intentions (cli/play.py) ET par le claim_validator (llm/).
# Centralise ici pour eviter les imports circulaires.
