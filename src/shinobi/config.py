...
class Settings(BaseSettings):
    ...
    # Anti-hallucination validator (piliers 2-3-6B-7)
    # Active par defaut. Trappe d'evacuation pour debug, mesure d'impact, rollback.
    enable_anti_hallu_validation: bool = True
